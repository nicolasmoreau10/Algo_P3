...
# url1 = 'https://drive.google.com/file/d/1bY_cPv5r8nMAECNtkah0tvsN6_iAfM_c/view?usp=share_link'
...
image_local('C:\\Users\\Administrateur\\Projet_3\\Algo_P3\\fond-court-tennis.png')
...
# STREAMLIT
st.markdown("<h1 style='text-align: center;'> JEU, SET AND DASH ! </h1>", unsafe_allow_html=True)
...
if not ((player1 == "Sélectionnez un joueur") or (player2 == "Sélectionnez un joueur")) :
...
#     st.plotly_chart(fig)
    ...
    if choix_surfaces != 'Choisissez une surface' :
        ...
        if bouton :
            ...
            moy_df= pd.read_csv(path +"DFMOYV5b.csv")
