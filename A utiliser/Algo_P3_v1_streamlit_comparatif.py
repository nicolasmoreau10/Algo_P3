...
choix_surfaces = col3.selectbox("Choisissez une surface", options = ['Clay', 'Grass', 'Hard'], key="C")
...
if bouton :
    ...
    moy_df= pd.read_csv("C:\\Users\\Administrateur\\Projet_3\\Algo_P3\\DFMOYV3.csv")
